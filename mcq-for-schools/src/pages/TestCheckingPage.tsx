...
export default function TestCheckingPage() {
  ...
  const scanAnswerSheets = async () => {
    ...
    try {
      ...
      const apiBaseUrl = import.meta.env.VITE_OPENCV_API_URL || 'http://localhost:8000';
      ...
      for (const result of uniqueResults) {
        try {
          ...
          if (result.rawOcrData && result.rawOcrData.result_image_url) {
            const fullUrl = `${import.meta.env.VITE_OPENCV_API_URL || 'http://localhost:8000'}${result.rawOcrData.result_image_url}`;
      ...
      <div className="mb-6">
        ...
        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
          ...
          <p className="text-sm text-blue-700 mt-1">
            ...
            to the OpenCV API running at {import.meta.env.VITE_OPENCV_API_URL || 'http://localhost:8000'}.
